// DEPRECATED - test file for deprecated parsing strategy
// rename to 'parsing-utils-deprecated.spec.ts' to revive as test file

import { compareVersionsAscending, compareVersionsDescending } from "./parsing-utils-deprecated";
