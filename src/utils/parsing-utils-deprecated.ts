// DEPRECATED - util file for deprecated parsing strategy
// parses and sorts version numbers from the "software version" 
// section of solana feature status CLI output
// look at 'parsing-utils.ts' for up to date parsing strategy
